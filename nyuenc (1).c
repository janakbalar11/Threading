...
//                         if (current_letter != '\0') {
//                           pthread_mutex_lock(&result_mutex);
//                             fwrite(&current_letter, 1, 1, stdout);
//                             fwrite(&current_num, 1, sizeof(unsigned char), stdout);  
//                            pthread_mutex_unlock(&result_mutex);
//                         }
//                         current_letter = c;
//                         current_num = 0;
...
// pthread_mutex_unlock(&mutex);
  ...
  //       if (c != current_letter) {
  //         if (current_letter != '\0') {
  //           // printf("%c%d", current_letter, current_num);
  //           fwrite(&current_letter,1,1,stdout);
  //           fwrite(&current_num,1,sizeof(unsigned char),stdout);
  //         }
  //         current_letter = c;
